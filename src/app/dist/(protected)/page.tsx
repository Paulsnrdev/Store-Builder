  ...
  return (
    <div>
      ...
      <div className="mt-6 flex gap-4">
        <Link href="/dist/businesses" className="rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800">
          Manage businesses
        </Link>
        <Link href="/dist/plans" className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
          Manage plans
        </Link>
      </div>
    </div>
